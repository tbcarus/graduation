...
<div class="jumbotron py-0">
    <div class="container">
        ...
        <br/>
        <p>
            <button type="submit" class="btn btn-lg btn-primary" onclick="login('vasily@mail.ru', 'vasilypass')">
                <spring:message code="app.login"/> Vasiliy
            </button>
            <button type="submit" class="btn btn-lg btn-primary" onclick="login('maria@mail.ru', 'mariapass')">
                <spring:message code="app.login"/> Maria
            </button>
            <button type="submit" class="btn btn-lg btn-primary" onclick="login('ivan@mail.ru', 'ivanpass')">
                <spring:message code="app.login"/> Ivan
            </button>
            <button type="submit" class="btn btn-lg btn-primary" onclick="login('admin@gov.ru', 'superAdmin')">
