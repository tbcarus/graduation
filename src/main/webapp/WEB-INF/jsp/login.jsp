    ...
    <div class="container">
        ...
        <sec:authorize access="isAnonymous()">
            <div class="pt-2">
                ...
                <button type="submit" class="btn btn-lg btn-primary mt-2" onclick="login('maria@mail.ru', 'mariapass')">
                    <spring:message code="app.login"/> Maria
                </button>
                <button type="submit" class="btn btn-lg btn-primary mt-2" onclick="login('ivan@mail.ru', 'ivanpass')">
                    <spring:message code="app.login"/> Ivan
                </button>
                <button type="submit" class="btn btn-lg btn-primary mt-2" onclick="login('admin@gov.ru', 'superAdmin')">
